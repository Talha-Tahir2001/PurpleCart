...
const Cart: FC = () => {
    const { products, currency, cartItems, setCartItems, removeFromCart, getCartCount, updateCartItem,
        navigate, getCartAmount, axios: api, user } = useAppContext();
        ...
        <div className="flex flex-col md:flex-row mt-12">
                            ...
                            <div>
                                ...
                                <div className="font-normal text-gray-500/70">
                                    ...
                                    <div className='flex items-center'>
                                        <p>Qty:</p>
                                        <select aria-label="Product quantity" onChange={(e) => updateCartItem(product._id, Number(e.target.value))}
            ...
            <div className="max-w-90 w-full bg-gray-100/40 p-5 max-md:mt-16 border border-gray-300/70">
                ...
                <div className="mb-6">
                    ...
                    <select aria-label="Payment method" onChange={(e) => setPaymentOption(e.target.value as "COD" | "Online")} className="w-full border border-gray-300 bg-white px-3 py-2 mt-2 outline-none">
